...
select c.customer_id, c.first_name, c.last_name, min(o.ORDER_DATE) first_order_date, 
max(o.ORDER_DATE) most_recent_order_date, count(o.order_id) number_of_orders, sum(p.amount) lifetime
